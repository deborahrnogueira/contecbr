...
def carregar_dados(uploaded_file):
    ...
    try:
        ...
        if file_extension == 'csv':
            ...
            # Ler especificamente as colunas A até Q, começando da linha 12
            df = pd.read_excel(
                uploaded_file,
                sheet_name='ARP',  # Alterado para a aba ARP
                usecols='A:Q',     # Alterado para colunas A até Q
                skiprows=11,       # Pula as primeiras 11 linhas para começar na linha 12
                nrows=306          # Lê até a linha 317 (317-12+1 = 306 linhas)
            )
        else:
